...
return array(
	...
	'Replace image'                                                                                                                                                                       => __( 'Replace image',
		'domain-mapping-system' ),
	'Use the radio button to select a Microsite homepage. Read our {0} documentation {1} for details.'                                                                                    => __( 'Use the radio button to select a Microsite homepage. Read our {0} documentation {1} for details.',
		'domain-mapping-system' ),
	'Enter Mapped Domain'                                                                                                                                                                 => __( 'Enter Mapped Domain', 'domain-mapping-system' ),
	'Enter Subdirectory (optional)'                                                                                                                                                       => __( 'Enter Subdirectory (optional)', 'domain-mapping-system' ),
	'Select the Published Content to Map for this Domain.'                                                                                                                                => __( 'Select the Published Content to Map for this Domain.', 'domain-mapping-system' ),
	'Custom HTML Code'                                                                                                                                                                    => __( 'Custom HTML Code', 'domain-mapping-system' ),
	'Favicon per Domain'                                                                                                                                                                  => __( 'Favicon per Domain', 'domain-mapping-system' ),
	'Code here'                                                                                                                                                                           => __( 'Code here', 'domain-mapping-system' ),
);