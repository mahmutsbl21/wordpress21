            ...
            ?>
                    <div class="dmsy-upgrader">
                        <p style="padding: 0 16px">
							<?php 
            echo sprintf( __( 'To customize Yoast meta content per domain, please %s', 'domain-mapping-system' ), ' <a class="upgrade" href="' . $this->fs->get_upgrade_url() . '">' . __( 'Upgrade', 'domain-mapping-system' ) . '&#8594;</a>' );
            ?>
                        </p>
                    </div>
					<?php 
        ...
        foreach ( $data as $key => $item ) {
            ...
            ?>"
                                           aria-selected="false" tabindex="-1">
                                            <span><?php 
            echo __( 'SEO', 'domain-mapping-system' );
            ?></span>
                                        </a>
                                    </li>
            ...
            ?>" aria-selected="false" tabindex="-1">
                                            ...
                                            <span><?php 
            echo __( 'Social', 'domain-mapping-system' );
            ?></span>
                                        </a>
                                    </li>
                                </ul>
            ...
            echo __( 'Title', 'domain-mapping-system' );
            ?></span>
                                        <input class="dmsy-tabs-input"
                                               name="<?php 
            echo Seo_Yoast::$form_prefix;
            ?>title<?php 
            echo Seo_Yoast::$domain_separator . esc_attr( $hostAndPath );
            ?>"
                                               type="text"
                                               value="<?php 
            ...
            ?>"
                                ...
                                <div class="dmsy-tabs-row">
                                    <label class="dmsy-tabs-input-holder">
                                        <span class="dmsy-tabs-input-label"><?php 
            echo __( 'Description', 'domain-mapping-system' );
            ?></span>
                                        <input class="dmsy-tabs-input"
                                               name="<?php 
            echo Seo_Yoast::$form_prefix;
            ...
            ?>"
                                ...
                                <div class="dmsy-tabs-row">
                                    <label class="dmsy-tabs-input-holder">
                                        <span class="dmsy-tabs-input-label"><?php 
            echo __( 'Keywords', 'domain-mapping-system' );
            ?></span>
                                        <input class="dmsy-tabs-input"
                                               name="<?php 
            echo Seo_Yoast::$form_prefix;
                                ...
                                <div class="dmsy-tabs-group">
                                    <div class="dmsy-tabs-row">
                                        <div class="dmsy-tabs-upload">
                                            <span class="dmsy-tabs-input-label"><?php 
            echo __( 'Social Image', 'domain-mapping-system' );
            ?></span>
                                            <button class="dmsy-tabs-upload-button" type="button"><?php 
            echo ( !empty( $meta_data['opengraph-image'] ) ? __( 'Replace image', 'domain-mapping-system' ) : __( 'Select image', 'domain-mapping-system' ) );
            ?></button>
            ...
            echo __( 'Remove image', 'domain-mapping-system' );
            ?></a>
											<?php 
            ...
            ?>
                                        ...
                                        <label class="dmsy-tabs-input-holder">
                                            <span class="dmsy-tabs-input-label"><?php 
            echo __( 'Social Title', 'domain-mapping-system' );
            ?></span>
                                            <input class="dmsy-tabs-input"
                                                   name="<?php 
            echo Seo_Yoast::$form_prefix;
            ...
            ?>">
                                    ...
                                    <div class="dmsy-tabs-row">
                                        <label class="dmsy-tabs-input-holder">
                                            <span class="dmsy-tabs-input-label"><?php 
            echo __( 'Social Description', 'domain-mapping-system' );
            ?></span>
                                            <input class="dmsy-tabs-input"
                                                   name="<?php 
            echo Seo_Yoast::$form_prefix;
            ...
            ?>">
                                ...
                                <div class="dmsy-tabs-group">
                                    <div class="dmsy-tabs-row">
                                        <div class="dmsy-tabs-upload">
                                            <span class="dmsy-tabs-input-label"><?php 
            echo __( 'Twitter Image', 'domain-mapping-system' );
            ?></span>
                                            <button class="dmsy-tabs-upload-button" type="button"><?php 
            echo ( !empty( $meta_data['twitter-image'] ) ? __( 'Replace image', 'domain-mapping-system' ) : __( 'Select image', 'domain-mapping-system' ) );
            ?></button>
            ...
            ?>
                                        ...
                                        <label class="dmsy-tabs-input-holder">
                                            <span class="dmsy-tabs-input-label"><?php 
            echo __( 'Twitter Title', 'domain-mapping-system' );
            ?></span>
                                            <input class="dmsy-tabs-input"
                                                   name="<?php 
            echo Seo_Yoast::$form_prefix;
            ...
            ?>">
                                    ...
                                    <div class="dmsy-tabs-row">
                                        <label class="dmsy-tabs-input-holder">
                                            <span class="dmsy-tabs-input-label"><?php 
            echo __( 'Twitter Description', 'domain-mapping-system' );
            ?></span>
                                            <input class="dmsy-tabs-input"
                                                   name="<?php 
            echo Seo_Yoast::$form_prefix;
